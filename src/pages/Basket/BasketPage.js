      ...
      <div className='firstContent'>
        ...
        <div className='LeftSide1'>
          ...
          <div className='CardContent11'>
            <Cards 
              ImgUrl={"https://cdn.dsmcdn.com/ty32/product/media/images/20201214/5/38225489/19472655/1/1_org.jpg"}
        ...
        <div className='RightSideCard'>
         ...
         <div className='RightSideImg'>
              <img alt='s' className='RightSideImg2' src='https://cdn.dsmcdn.com/web/production/pudo-banner-with-new-pudo-user.svg'></img>
         </div>
