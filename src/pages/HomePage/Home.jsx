        ...
        <div className="smallDives">
          <div className="imgcss4">
            <img
              className="imgcss5"
              alt="s"
              src="https://cdn.dsmcdn.com/ty567/campaign/banners/original/611090/0c84339d0f_0.jpg"
            ></img>
          </div>
        ...
        <div className="smallDives">
          <div className="imgcss4">
            <img
              className="imgcss5"
              alt="s"
              src="https://cdn.dsmcdn.com/ty562/pimWidgetApi/mobile_20221014125744_EHMyeni.jpg"
            ></img>
          </div>
        ...
        <div className="smallDives">
          <div className="imgcss4">
            <img
              className="imgcss5"
              alt="s"
              src="https://cdn.dsmcdn.com/ty579/campaign/banners/original/615527/76b876c0b2_0.jpg"
            ></img>
          </div>
